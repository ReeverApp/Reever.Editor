export class ReeverEditor {
    ...
    constructor(editorSelector: string) {
        ...
        if (!el) throw new Error("Editor bulunamadı");
        this.editorEl = el as HTMLElement;
    ...
    insertImage(url: string) { document.execCommand("insertImage", false, url); this.editorEl.focus(); }
    setContent(html: string) { this.editorEl.innerHTML = html; }
